...
public class Temperaturas {
    ...
    public static void main(String[] args) {
        ...
        while (continuar == true){//JCL20252410: tenía un false, que hacia que nunca se pudiera ejecutar
            ...
            if (respuesta.equalsIgnoreCase("n")) {//la condicion no se cumplia y continuar nunca se volvia false
                continuar = false;
            }
    ...
    public static double pedirTemperatura(Scanner sc) {
        ...
        do {
            ...
            t = sc.nextDouble();
            if (t < -10 || t > 50) {//no podia ser un numero mayor y menor a la vez
                System.out.println("Temperatura fuera del rango permitido (-10 a 50).");//JCL20252410: No estaba el ;
            }
        } while (t < -10 || t > 50);//no podia ser un numero mayor y menor a la vez
        return t;
    }
